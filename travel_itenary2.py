...
if st.session_state.itinerary:
    ...
    selected_state = st.selectbox("Select State", ["Rajasthan", "Madhya Pradesh"])
    ...
    for car in cars_data:
        if budget == "Low" and car["price"] <= 1800:
            filtered_cars.append(car)
        elif budget == "Medium" and 1800 < car["price"] <= 3000:
            filtered_cars.append(car)
        elif budget == "High" and car["price"] > 3000:
            filtered_cars.append(car)
...
city = st.session_state.get("selected_city", "Delhi")
